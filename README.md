...
- Arach Kernel `192294c05b1082a884ac11b0d52d2283d8397620`;
...
exact-frame return, and measured multi-member `exit_group`. The pinned package
repository contains kernel recipe release 26, Elan Guardian 0.2.6, and
