...
test -f "$root/scripts/verify_release_channels.py"
test -f "$root/scripts/test_verify_components.py"
test -f "$root/scripts/test_verify_workflow_pins.py"
test -f "$root/tests/test_marker_sequence.py"
test -f "$root/tests/test_production_readiness.py"
test -f "$root/tests/test_release_channels.py"
...
python3 "$root/scripts/verify_production_readiness.py" --root "$root"
python3 "$root/tests/test_production_readiness.py"
